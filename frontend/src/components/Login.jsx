    ...
    <>
      ...
      >
        <div className="h-120 w-220  flex justify-center rounded-lg overflow-hidden shadow-xl/20">
                ...
                {inputs.map((input, idx) => (
                  <label key={idx} className="text-2xs font-medium">
                    ...
                    <input
                      ...
                      className="text-neutral-600  border rounded-md px-2 py-1.5 w-80 focus:outline-none focus:ring-1 focus:ring-sky-400 hover:outline-1"
                      autoComplete="off"
                    />
                  </label>
                ))}
          ...
          <div className="w-[50%] bg-[url(https://media2.giphy.com/media/v1.Y2lkPTZjMDliOTUyOG91d29sNjJmNWVpbHlleWpmam01M2sydmRvNXE0Zjh2MHpoOXpuNSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/EbRPam1A4jEWkUokL8/200w.gif)] bg-center bg-cover  bg-no-repeat"></div>
        </div>
      </div>
    </>
  );
