  ...
  return (
    <>
      <div className="overflow-x-hidden [scrollbar-width:none] absolute -z-10 inset-0 h-full w-full 
        ...
        {/* Hero */}
        <div className="h-[28%] md:h-[45%] flex justify-center items-center w-full">
          <div className="text-center flex justify-center items-center gap-4 flex-col">
            <motion.h1 initial={{ opacity: 0, y: -30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="text-4xl md:text-6xl font-extrabold">Second Brain🧠</motion.h1>
            <motion.h4
        ...
        {/* Features */}
        <div className="flex justify-center items-center flex-col gap-8 md:mt-4">
